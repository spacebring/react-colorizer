...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorPickerComponent_1 = __webpack_require__(159);
	...
	ReactDOM.render(React.createElement(ColorPickerComponent_1.ColorPickerComponent, {"height": 50, "onColorChangedCallback": onColorChangedCallback}), document.getElementById('ColorPickerContainer'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BaseColorPickerComponent_1 = __webpack_require__(162);
	var BrightnessPickerComponent_1 = __webpack_require__(164);
	var ColorPickerComponent = (function (_super) {
	    __extends(ColorPickerComponent, _super);
	    function ColorPickerComponent(props) {
	        _super.call(this, props);
	        this.state = {
	            baseColor: this.props.defaultColor || new color_1.Color(255, 0, 0),
	            color: this.props.defaultColor || new color_1.Color(255, 0, 0),
	    ...
	    ColorPickerComponent.prototype.setBrightnessPickerBase = function (baseColor) {
	        var newMainColor;
	    ...
	    ColorPickerComponent.prototype.onBrightnessPickerColorChanged = function (position) {
	    ...
	    ColorPickerComponent.prototype.getMainColor = function (position) {
	        var baseColor = this.state.baseColor, newMainColor = new color_1.Color(0, 0, 0);
	        if (position < 0.5) {
	    ...
	    ColorPickerComponent.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement(BaseColorPickerComponent_1.BaseColorPickerComponent, {"height": this.props.height, "color": this.state.baseColor, "onBaseColorChanged": this.setBrightnessPickerBase}), React.createElement(BrightnessPickerComponent_1.BrightnessPickerComponent, {"height": this.props.height, "color": this.state.baseColor, "position": this.state.brightnessPosition, "onPositionChanged": this.onBrightnessPickerColorChanged})));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var color_1 = __webpack_require__(160);
	var ColorPickerCircleComponent_1 = __webpack_require__(163);
	var BaseColorPickerComponent = (function (_super) {
	    __extends(BaseColorPickerComponent, _super);
	    function BaseColorPickerComponent(props) {
	        _super.call(this, props);
	        this.onPositionChanged = this.onPositionChanged.bind(this);
	    }
	    BaseColorPickerComponent.prototype.onPositionChanged = function (position) {
	        var index, index1, index2, percent, color = new color_1.Color(0, 0, 0), colors = [
	            new color_1.Color(0, 169, 224),
	            new color_1.Color(50, 52, 144),
	            new color_1.Color(234, 22, 136),
	            new color_1.Color(235, 46, 46),
	            new color_1.Color(253, 233, 45),
	            new color_1.Color(0, 158, 84),
	            new color_1.Color(0, 158, 84)
	        ];
	        index = position * 5;
	    ...
	    BaseColorPickerComponent.prototype.render = function () {
	        var style = {
	            height: this.props.height + 'px'
	        };
	        return (React.createElement("div", {"className": "colorPickerGradient colorPickerHueGradient", "style": style}, React.createElement(ColorPickerCircleComponent_1.ColorPickerCircleComponent, {"size": this.props.height / 2, "position": 0.5, "top": this.props.height / 4, "onPositionChanged": this.onPositionChanged})));
	    };
	    return BaseColorPickerComponent;
	})(React.Component);
	exports.BaseColorPickerComponent = BaseColorPickerComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ColorPickerCircleComponent = (function (_super) {
	    __extends(ColorPickerCircleComponent, _super);
	    function ColorPickerCircleComponent(props) {
	        ...
	        this.onMouseMove = function (e) {
	            ...
	            _this.setState({
	                position: (e.pageX - _this.state.parentLeft) / _this.state.parentWidth
	            });
	            if (_this.state.position > 1) {
	                _this.setState({
	                    position: 1
	                });
	            }
	            ...
	            _this.props.onPositionChanged(_this.state.position);
	        };
	    ...
	    ColorPickerCircleComponent.prototype.render = function () {
	        var size = this.props.size, style = {
	            height: size + 'px',
	            width: size + 'px',
	        ...
	        return (React.createElement("div", {"className": "colorPickerCircle", "style": style, "onMouseDown": this.onMouseDown}));
	    };
	    return ColorPickerCircleComponent;
	})(React.Component);
	exports.ColorPickerCircleComponent = ColorPickerCircleComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ColorPickerCircleComponent_1 = __webpack_require__(163);
	var BrightnessPickerComponent = (function (_super) {
	    __extends(BrightnessPickerComponent, _super);
	    function BrightnessPickerComponent(props) {
	        _super.call(this, props);
	        this.onPositionChanged = this.onPositionChanged.bind(this);
	    }
	    BrightnessPickerComponent.prototype.onPositionChanged = function (position) {
	        this.props.onPositionChanged(position);
	    };
	    BrightnessPickerComponent.prototype.render = function () {
	        var style = {
	            height: this.props.height + 'px',
	            backgroundImage: 'linear-gradient(90deg, rgb(255, 255, 255) 0%, #' + this.props.color.toHex() + ' 50%, rgb(0, 0, 0) 100%)'
	        };
	        return (React.createElement("div", {"className": "colorPickerGradient", "style": style}, React.createElement(ColorPickerCircleComponent_1.ColorPickerCircleComponent, {"size": this.props.height / 2, "position": this.props.position, "top": this.props.height / 4, "onPositionChanged": this.onPositionChanged})));
	    };
	    return BrightnessPickerComponent;
	})(React.Component);
	exports.BrightnessPickerComponent = BrightnessPickerComponent;
