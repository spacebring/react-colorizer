    ...
    return (
      <div>
        ...
        <div style={{
          ...
          <button style={{marginBottom: 10, marginTop: 20}} onClick={this.onSetRandomColor}>Set random color</button>
        </div>
        <div style={{ backgroundColor: this.state.color, width: COLORIZER_WIDTH, height: 40, alignItems: 'center', display: 'flex', justifyContent: 'center', fontFamily: 'monospace', fontWeight: 200 }} >
          {this.state.color}
        </div>
        <br />
        <div style={{
        ...
        <div style={{ display: 'flex', flexFlow: 'row wrap', justifyContent: 'flex-start', width: COLORIZER_WIDTH, fontFamily: 'monospace', fontWeight: 200  }} >
          {colors.map((color, index) => (
            <div key={index} style={{ alignItems: 'center', display: 'flex', justifyContent: 'center', backgroundColor: color, height: 40, width: '20%' }} >
              {color}
            </div>
          ))}
        </div>
